      ...
      <section className="container max-w-[900px] space-y-8 mt-8">
        <div className="grid gap-y-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 *:text-center">
          ...
          <div>
            ...
            <p>
              {exam?.level} {exam?.level !== "IJMB" && "Level"}
            </p>
          </div>
          <div>
        ...
        <div
          className={`bg-gray-50 dark:bg-secondary-dark-100 p-6 rounded-lg shadow-sm grid gap-4 grid-cols-1 ${exam?.questions >= 10 && exam?.type == "objective" ? "sm:grid-cols-3" : "sm:grid-cols-2"}`}
        >
          <div className="space-y-2">
            <div className="flex items-center gap-1 space-x-1">
              ...
              <div className="dropdown dropdown-hover dropdown-right">
                ...
                <div
                  tabIndex={0}
                  className="dropdown-content ml-2 bg-white border p-4 rounded-md"
                >
                  <p className="text-sm">
                    <Link
                    ...
                    about exam modes in schoolarlyq.
                  </p>
                </div>
              </div>
            </div>
            <select
              value={mode}
              onChange={(e) => setMode(e.target.value as "exam" | "study")}
              id="mode"
          ...
          {exam?.questions >= 10 && exam?.type == "objective" && (
            <div className="space-y-2">
              ...
              <select
                ...
                disabled={mode == "exam"}
              >
                {Array.from({ length: exam?.questions }, (_, i) => i + 1)
                  .filter((val) => val % 10 === 0)
                  .map((val) => (
          ...
          <div className="space-y-2">
            <label htmlFor="timer" className="font-semibold">
              Timer
            </label>
            <select
        ...
        <div className="text-center">
          <Button
            ...
            loading={startQuizStatus === "loading"}
