...
const Quiz = () => {
  ...
  return (
    <main className="mt-8">
      <section className="bg-primary-light-100 h-[300px] dark:bg-primary-dark-100">
      ...
      <section className="container flex mt-4">
        <div className="basis-1/5 divide-y-[1px] *:py-4">
          <div className="!pt-0">
            <p className="text-2xl font-semibold">Filter</p>
            <p onClick={() => setParams({})} className="cursor-pointer w-fit text-sm text-primary-light-300 hover:underline dark:text-primary-dark-300">Clear all</p>
          </div>
