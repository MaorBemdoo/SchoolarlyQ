export const faculties = [
  ...
  },
  {
    ...
    departments: [
      { id: 14, name: "Morbid Anatomy" },
      { id: 15, name: "Medical Microbiology and Parasitology" },
      { id: 16, name: "Haematology and Blood Transfusion" },
      { id: 17, name: "Pharmacology & Therapeutics" },
      { id: 18, name: "Chemical Pathology" },
      { id: 19, name: "Surgery" },
      { id: 20, name: "Obstetrics & Gynaecology" },
      { id: 21, name: "Community Medicine & Primary Health Care" },
      { id: 22, name: "Internal Medicine" },
  ...
  },
  {
    ...
    departments: [
      { id: 27, name: "Pharmaceutics and Pharmaceutical Technology" },
      { id: 28, name: "Pharmacology and Toxicology" },
